...
namespace KOIPMonitor
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            KoIp.Commonality.ConsoleManage.objectTime();
            ...
            if (dt.Rows.Count != 0)
            {
                ...
                if (listener.IsBound)
                {
                    KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Serious, "KOIPMonitor：SOCKET=" + CommClass.IP + ":" + CommClass.PORT.ToString() + "  TCP服務啟動成功", "");
                }
                else
                {
                    KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Serious, "KOIPMonitor：SOCKET=" + CommClass.IP + ":" + CommClass.PORT.ToString() + "   TCP服務啟動失敗", "");
