                    ...
                    using (BinaryWriter bw = new BinaryWriter(ms))
                    {
                        ...
                        if (state != null)
                        {
                            if (state.workSocket.Connected)
                            {
                                ...
                                KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Response, "SendDatas", "CMD=" + cmd1.ToString() + " " + "BACKCODE=" + cmd2.ToString() + ">>IPaddress:" + state.wanIP.ToString() + ">>Port:" + state.wanPort.ToString());
                            }
                            else
                            {
                                KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Response, "SendDatas", "state.workSocket is not Connected");
                        ...
                        {
                            KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Response, "SendDatas", "StateObject is null");
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    using (BinaryWriter bw = new BinaryWriter(ms))
                    {
                        ...
                        if (tcpClient.Connected)
                        {
                            ...
                            KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Response, "Client Send Data Success", "CMD=" + cmd1.ToString() + " " + "BACKCODE=" + cmd2.ToString());
                        }
                        else
                        {
                            KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Response, "CommonFunction>>TcpClientSend>>", "TCP Client Disconnect");
