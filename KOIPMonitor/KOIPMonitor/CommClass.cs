    ...
    class CommClass
    {
        ...
        public static void OutputBody(DataTable dt)
        {
            try
            {
                ...
                KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Serious, "KNS>>CommClass>>OutputBody", StrBody);

            }
            catch (Exception ex)
            {
                KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Serious, "KNS>>CommClass>>OutputBody", ex.Message);
