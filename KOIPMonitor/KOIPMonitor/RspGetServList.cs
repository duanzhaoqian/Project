    ...
    class RspGetServList
    {
        ...
        public static void process(StateObject request)
        {
            ...
            try
            {
                ...
                {
                    KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Serious, "RspGetServList>>process>>", "StateObject request==null");
                }
            }
            catch (Exception ex)
            {
                KoIp.Commonality.ConsoleManage.Write(KoIp.Commonality.ErrorLevel.Serious, "RspGetServList>>process>>", ex.Message);
