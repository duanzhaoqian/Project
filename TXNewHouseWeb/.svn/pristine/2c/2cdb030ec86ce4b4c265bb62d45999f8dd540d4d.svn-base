    ...
    <div class="yellow_box1 r_y_kj clearFix">
        ...
        <div class="part4">
            ...
            <%
              ...
              {
            %>
            <a href="#kanjia" class="s-link-d mt10">立刻砍价</a>
            <% 
              }
              //如果活动时间已经结束
              else
...
<div class="w1190">
    ...
    <div class="yellow_box1 yellow_box2 clearFix mb15">
        ...
        <div class="part5 mt15 mr20">
            <div class="pos_abs">
                <input type="button" value="砍价结束" class="btn_w126_gray"></div>
            <p class="tar">
    ...
    <div class="gray_box gray_box1 clearFix">
        <div class="right">
            ...
            <div class="page tac border_top">
                <span class="col333 font12 mr10">共 <em class="col666" id="totalCount"></em>条记录</span> <span
                    id="page"></span>
            </div>
        </div>
        <div class="left mr20">
        ...
        <div class="left">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <%--  <a href="/Login/login/"><input type="button" class="btn_w110_yellow" value="登录"></a>--%>
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <p>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="0" class="login_table"
                    ...
                    {
                                %>
                                <input type="submit" disabled="disabled" class="btn_w126_yellow" value="提交我的信息" />
                                <%
                    }
                    //如果活动正在进行中
                    else if (_activity.BeginTime <= DateTime.Now && _activity.EndTime > DateTime.Now)
            ...
            $.post("<%=TXCommons.GetConfig.GetSiteRoot%>/Premises/BidPricesPage", { m: Math.random(), activityId: activityId, houseId: houseId, pageIndex: index, type: type1 }, function (d) {
                if (d != "0") {
                    ...
                    for (var i = 0; i < RevList.length; i++) {
                        ...
                        // result += "<tr>" + tval + "<td>" + item.BidUserPrice.substring(0, item.BidUserPrice.indexOf(".")) + "万元</td><td>" + item.CreateTime.toString() + "</td><td>" + item.BidUserMobile + "</td></tr>";
