...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content">
        <div class="mt15 btit clearFix">
            ...
            <div class="font14 fr mr35">
                <a href="<%=TXCommons.GetConfig.BaseUrl%>Activity/APrice">创建一口价</a></div>
        </div>
        <div class="shaibox mt15 clearFix">
           ...
           <a href="#">东方青青</a>--%>
            ...
            <div class="selbox mr10">
                ...
                <div class="sel_list w300" style="display: none;">
                    <a data-buidid='-1' onclick='return SelectOption(this,1)'>选择楼栋</a>
                </div>
            </div>
            <div class="selbox mr10">
                <span class="pl10">选择单元</span>
                <div class="sel_list" style="display: none;">
                    <a data-unitid='-1' onclick='return SelectOption(this,2)'>选择单元</a>
                </div>
            </div>
            <div class="selbox mr10">
                <span class="pl10">选择楼层</span>
                <div class="sel_list" style="display: none;">
                    <a data-floorid='-100' onclick='return SelectOption(this,3)'>选择楼层</a>
                </div>
            </div>
            <div class="selbox mr10">
                <span class="pl10">选择状态</span>
                <div class="sel_list" style="display: none;">
                    <a data-activstate="-1">选择状态</a> <a data-activstate="0">未开始</a> <a data-activstate="1">
                        进行中</a> <a data-activstate="2">已结束</a>
                </div>
            </div>
    ...
    <script type="text/javascript">
            ...
            $(".select1").change(function () {
                ...
                jQuery.ajax({ type: "post", async: false, url: mainUrl + "/Activity/GetBuilding", data: { PremisesId: PremiseId, m: Math.random() }, dataType: "json", cache: false,
                    success: function (data) {
                        ...
                        //首个a标签
                        var attr = "buidid";
                        var firstlink = "<a data-buidid='-1' onclick='return SelectOption(this,1)'>选择楼栋</a>";
        ...
        function QueryHouse() {
            ...
            jQuery.ajax({ type: "get", async: false, url: mainUrl + "/Activity/APriceList", data: { premisesId: premisesId, buildId: buildId, unitId: unitId, floorId: floorId, activState: activState, m: Math.random() }, cache: false,
                success: function (data) {
