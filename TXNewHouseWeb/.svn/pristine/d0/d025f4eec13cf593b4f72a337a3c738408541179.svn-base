<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TXNewHouseManager.Master"
    Inherits="WebRentViewPage<TXModel.AdminPVM.PVE_NH_Premises2>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="current">
        ...
        <span><a href="javascript:void(0);">
            ...
            <i>&gt;</i> <a href="javascript:void(0);">
                <%=AdminPageInfo.ItemName %></a><i>&gt;</i><a href="javascript:void(0);">发布楼盘</a></span>
    </div>
    <!--//current-->
    <div class="data">
            ...
            <div class="tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    <tr>
                        ...
                        <td width="89%">
                            <input id="name" type="text" maxlength="50" /><span id="len_name" style="color: #999999;
                                padding-left: 10px;"></span>&nbsp;&nbsp;<span id="err_name"></span>
                        </td>
                    </tr>
                    <tr>
                        <th width="11%">
                        ...
                        <td width="89%">
                            <%Html.RenderAction("UploadPremisesPhotoLogo", "Premises", new { guid = ViewData["guid"].ToString(), picturetype = TXCommons.PictureModular.PremisesPictureType.Logo.ToString(), cityId = 0 }); %><span
                                id="err_logo"></span>
                            <input type="hidden" id="hid_logo" value="0" />
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input id="referenceprice" type="text" maxlength="15" />&nbsp;&nbsp;元&nbsp;&nbsp;<span
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="telephone" type="text" maxlength="20" />&nbsp;&nbsp;<span id="err_telephone"></span>
                            <input id="chk400" type="checkbox" checked="checked" style="display: none;" />&nbsp;&nbsp;<%--使用400转接电话。--%>所填写的咨询电话会自动转换成我平台提供的400电话在前端显示
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <%= Html.DropDownListFor(model => model.SalesStatus, Model.SalesStatusList, new {@readonly = "readonly"}) %><span
                    ...
                    <tr>
                        ...
                        <td>
                            <em>
                                <%= Html.DropDownListFor(model => model.ProvinceId, Model.ProvinceList, new {@class = "w100"}) %></em>
                            <em>
                                <%= Html.DropDownListFor(model => model.CityId, Model.Cities, new {@class = "w100"}) %></em>
                            <em>
                                <%= Html.DropDownListFor(model => model.DId, Model.Districts, new {@class = "w100"}) %></em>&nbsp;&nbsp;<span
                                    id="err_DId"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <%= Html.DropDownListFor(model => model.BId, Model.Businesses, new {@class = "w100"}) %>&nbsp;&nbsp;<span
                                id="err_BId"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <%= Html.DropDownListFor(model => model.Ring, Model.RingList, new {@readonly = "readonly"}) %>&nbsp;&nbsp;<span
                                id="err_Ring"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input id="premisesaddress" type="text" class="txt22 w150" maxlength="200" />&nbsp;&nbsp;<span
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="salesaddress" type="text" class="txt22 w150" maxlength="200" />&nbsp;&nbsp;<span
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="developer" type="text" class="txt22 w150" maxlength="60" />&nbsp;&nbsp;<span
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="agent" type="text" class="txt22 w150" maxlength="60" />&nbsp;&nbsp;<em
                                ...
                                <input type="text" id="salePermit_0" class="txt22 w150" maxlength="50" isdel="0"
                                    oriid="0" /><input type="button" id="btnSalePermitAdd_0" value="添加" class="btn1 mr"
                                        style="top: -1px;" onclick="premises_salepermit.add(0)" /><input type="button" id="btnSalePermitDel_0"
                                            value="删除" class="btn1 mr" style="display: none; top: -1px;" onclick="premises_salepermit.del('0')" />
                            </p>
                        </td>
                    </tr>
                </table>
                ...
                <div class="tab1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                        <tr>
                            ...
                            <td width="89%">
                                <input id="propertyright" type="text" maxlength="2" />&nbsp;&nbsp;年<span id="err_propertyright"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="buildingarea" type="text" maxlength="9" />&nbsp;&nbsp;平方米<span id="err_buildingarea"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="area" type="text" maxlength="9" />&nbsp;&nbsp;平方米<span id="err_area"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="usercount" type="text" maxlength="9" />&nbsp;&nbsp;户<span id="err_usercount"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="bbtt_dd">
                                    <div>
                                        <% for (int i = 0; i < Model.PremisesFeatureList.Count; i++)
                                           {
                                        %>
                                        <input type="button" class="btn3" value="<%= ((PremisesFeature) Model.PremisesFeatureList[i]).Name %>"
                                            onclick="premises_characteristic.add('<%= ((PremisesFeature) Model.PremisesFeatureList[i]).Id %>','<%= ((PremisesFeature) Model.PremisesFeatureList[i]).Name %>')" />
                                        <% } %>
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <%= Html.DropDownListFor(model => model.BuildingType, Model.BuildingTypeList, new {@readonly = "readonly"}) %>&nbsp;&nbsp;<span
                ...
                <div class="tab1">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                        <tr>
                            ...
                            <td width="89%">
                                <input id="propertytype_1" type="checkbox" value="1" class="btn_checkbox" />住宅&nbsp;&nbsp;
                                <input id="propertytype_2" type="checkbox" value="2" class="btn_checkbox" />写字楼&nbsp;&nbsp;
                                <input id="propertytype_3" type="checkbox" value="3" class="btn_checkbox" />别墅&nbsp;&nbsp;
                                <input id="propertytype_4" type="checkbox" value="4" class="btn_checkbox" />商业&nbsp;&nbsp;<span
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="arearatio" type="text" maxlength="9" />&nbsp;&nbsp;<span id="err_arearatio"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="roomrate" type="text" maxlength="9" />&nbsp;&nbsp;%&nbsp;&nbsp;<span id="err_roomrate"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="propertyprice" type="text" maxlength="9" />&nbsp;&nbsp;/月/平方米&nbsp;&nbsp;<span
                                    id="err_propertyprice"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input id="parkinglot" type="text" maxlength="9" />&nbsp;&nbsp;位&nbsp;&nbsp;<span
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="propertycompany" type="text" class="txt22 w150" maxlength="60" />&nbsp;&nbsp;<span
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="greeningrate" type="text" maxlength="9" />&nbsp;&nbsp;%&nbsp;&nbsp;<span
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                        <tr>
                            ...
                            <td width="89%" align="left">
                                <input id="UpdateSandboxCoordinate" type="hidden" />
    ...
    <input type="hidden" id="hid_guid" value="<%= ViewData["guid"] %>" />
    <input type="hidden" id="DeveloperId" value="0" />
    <input type="hidden" id="PremisesId" value="0" />
    <script type="text/javascript">
        var SalePermitMaxId = 0; // 预售许可证编号
...
//                alert($("#chk400").prop("checked"));
                ...
                var url = '<%= Url.SiteUrl().Premises_action("SubmitPremises") %>';
                var data = {
                    // ----- ----- 基本资料
                    // 楼盘
                    Name: $("#name").val(),
