    ...
    <div class="current">
        ...
        <span><a href="javascript:void(0);">
            ...
            <i>&gt;</i> <a href="javascript:void(0);">
                <%=AdminPageInfo.ItemName %></a>-活动名称详情</span> <span style="float: right;"><a href="<%= ViewData["backurl"] %>">
                    返回阶梯团购列表</a> </span>
    </div>
    <div class="data">
        <div class="outer">
                    ...
                    <% for (int i = 0; i < 4; i++)
                       {
                        ...
                        <td>
                            当<input type="text" value="<%= i < Model.Socials.Count ? Convert.ToString(Model.Socials[i].UserCount) : "" %>" disabled="disabled"/>人，团购价格为<input type="text" value="<%= i < Model.Socials.Count ? Convert.ToString(Model.Socials[i].Discount) : "" %>" disabled="disabled"/> 折
                        </td>
                    </tr>
                           <%
                       } %>
