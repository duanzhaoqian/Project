...
<div class="r_title_lp">
    <span class="title_span">同价位最热楼盘排行</span></div>
<table width="100%" cellspacing="0" cellpadding="0" border="0">
    <tbody>
        ...
        <tr>
            <td>
                <a target="_blank" class="linkB" href="<%=TXCommons.NHWebUrl.PremisesIndexUrl(item.PremisesID) %>">
            ...
            <td align="right">
                <a href="javascript:void(0);" data="<%=Util.getStrLenB(item.PremisesName,0,24)%>" lang="<%=item.PremisesID %>"
                    url="<%=NHWebUrl.PremisesIndexUrl(item.PremisesID) %>" class="blue plus_compare">
                    对比</a>
            </td>
        </tr>
        <%}%>
