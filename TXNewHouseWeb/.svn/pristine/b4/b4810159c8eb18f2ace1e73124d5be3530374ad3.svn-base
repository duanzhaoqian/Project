...
%>
<div class="w1190">
    <div class="yellow_box1 r_y_ms clearFix">
        <div class="part1">
        ...
        <div class="part2 mt15">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td>
                        秒杀 <span class="r_wen_green ml20"><i class="r_layer_box">用户在规定时间内， 按照先到先得方式在线抢房，速度最快的买家，即竞购成功。
        ...
        <div class="part4">
            ...
            <%
              ...
              {
            %>
            <a href="javascript:void(0);" class="s-link-d mt10" onclick="startMS()">立刻秒杀</a>
            <% 
              }
              //如果活动时间已经结束
              else
...
<div class="w1190">
    ...
    %>
    <%
            //如果秒杀活动时间结束,房源在售状态则不显示，否则显示秒杀或秒杀结果
            if (Model.SalesStatus == 2 && _activity.EndTime < DateTime.Now) { }
            else
            {
    %>
    ...
    <div class="r_title_lp">
        <strong class="title_span pad_0_30">秒杀</strong><span class="col666 font12 ml15"><i
    ...
    <div class="yellow_box1 yellow_box2 clearFix">
        ...
        <div class="part5 mt15 mr20">
            <div class="pos_abs">
                <input type="button" value="秒杀结束" class="btn_w126_gray"></div>
            <p>
    ...
    <div class="r_title_lp">
        <strong class="title_span pad_0_30">营销活动规则</strong><span class="col666 font12 ml15"><i
            class="colff840b mr5 ml5"><%=ViewData["viewCount"]%></i>人围观</span></div>
    <div class="gray_box gray_box2 clearFix" id="A1">
        <div class="left" style="display: none;">
            ...
            <!--如果已登录--begin-->
            <p>
                <strong class="red">请填写您的联系信息。</strong></p>
                ...
                <table cellspacing="0" cellpadding="0" border="0" class="tab_k" style="margin: 0px 20px;">
                    <tbody>
                        <tr>
                            <td colspan="2">
                                <div class="red">
                                    秒杀成功，请完善或者核对您的个人信息；并在<%=TXCommons.GetConfig.MSOperatingTime%>分钟之内支付保证金，否者购房资格取消。</div>
                            </td>
                        </tr>
                        <tr>
                            <th align="right" scope="row">
            ...
            <script type="text/javascript">
                function startMS() {
                    ...
                    $.post("<%=TXCommons.GetConfig.GetSiteRoot%>/Premises/SubMSInfo", { houseId: houseId, activityId: activityId }, function (data) {
                        if (parseInt(data) > 0) {
                            $.freeDialog.open({ target: $('#userInfo_form'), title: '秒杀成功', height: 420, width: 560, allowClose: true, isResize: true });
                        }
                    ...
                    $("#bidpriceForm").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            $.ajax({
                                ...
                                dataType: "json",
                                data: { updatesalesstatus: 1, status: 1, bidtype: 3, price: price, realName: realName, code: code, mobile: mobile, qq: qq, email: email, activitiesId: activitiesId, developerId: developerId, houseId: houseId, type: 5 },
                                beforeSend: function (XMLHttpRequest) {
                                    //$(".btn_w126_yellow").attr("disabled", "disabled");
                                },
                                success: function (data) {
