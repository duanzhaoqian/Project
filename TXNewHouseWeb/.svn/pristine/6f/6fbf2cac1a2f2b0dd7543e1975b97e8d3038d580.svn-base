    ...
    <li id="imageBox_<%=info.ID %>" name="y">
        <dl>
            <dt>
               ...
               <img src="<%=TXCommons .PictureModular.Redis.IMGWEB_BASE+info.Path+ ".550_185.jpg" %>" width="550" height="185" />
...
<script type="text/javascript">
    function CreateImageBox(data) {
        ...
        var str = '<li id="imageBox_' + id + '">' +
          '<dl>' +
            '<dt><img src="' + pictureurl + '.550_185.jpg' + '" width="550" height="185" />' +
            '<a style ="cursor:pointer;" data="imageBox_' + id + '" onclick ="deleteimage(\'imageBox_' + id + '\')"  class="close">&nbsp;</a>' + picturetype + '</dt>' +
            '<dd>' + inputtxt +
    ...
    function bigimageclick(url, id) {
        ...
        $("#bigphoto").height(235);
        $("#bigphoto").width(700);
        $("div.big_img").width(700);
        $("div.big_img").height(235);
