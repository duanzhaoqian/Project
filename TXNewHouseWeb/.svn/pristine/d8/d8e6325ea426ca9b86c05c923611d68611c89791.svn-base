...
namespace TXCommons.ForKuaiYouJiaCookie
{
    public class BaseRC4
    {
        ...
        public String Encrypt(String data, String pass, BaseRC4.EncoderMode em)
        {
        ...
        /// <param name="em">编码模式</param>
        /// <returns>明文</returns>
        public String Decrypt(String data, String pass, BaseRC4.EncoderMode em)
        {
            if (data == null || pass == null) return null;
            if (em == EncoderMode.Base64Encoder)
        ...
        {
            RC4 rc4 = new RC4();
            //param = HttpUtility.UrlEncode(rc4.Encrypt(param, "kyj2012A906W828"));
            param = HttpUtility.UrlEncode(rc4.Encrypt(param, "kyj2012A906W927"));
            return param;
        }
        /// <summary>
        /// 解密
        ...
        public static string RC4Decrypt(string param)
        {
            ...
            try
            {
                //param = rc4.Decrypt(param, "kyj2012A906W828");//
                param = rc4.Decrypt(param, "kyj2012A906W927");
            }
            catch
            {
                //param = rc4.Decrypt(HttpUtility.UrlDecode(param), "kyj2012A906W828");
                param = rc4.Decrypt(HttpUtility.UrlDecode(param), "kyj2012A906W927");
            }
            return param;
        }
