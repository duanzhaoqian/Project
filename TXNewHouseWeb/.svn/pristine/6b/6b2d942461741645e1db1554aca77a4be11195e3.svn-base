...
{
    public class PVE_NH_Purchase_Detail
    {
        public int Id { set; get; }

        public string Name { set; get; }

        public string PremiseName { set; get; }

        public decimal Bond { set; get; }

        public int UserCount { set; get; }

        public List<PVM_NH_TuanGou_Social> Socials { set; get; }
        ...
        public List<PVE_NH_Discount_Houses> Houses { set; get; }
