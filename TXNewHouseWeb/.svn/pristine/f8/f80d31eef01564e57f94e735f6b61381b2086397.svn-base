<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TXNewHouseManager.Master"
    Inherits="WebRentViewPage<TXModel.AdminPVM.PVE_NH_Discount_Detail>" %>
        ...
        <span><a href="javascript:void(0);">
            ...
            <i>&gt;</i> <a href="javascript:void(0);">
                <%= AdminPageInfo.ItemName %></a> <i>&gt;</i><a href="javascript:void(0);"><%= Model.Name %>限时折扣活动</a></span><span
                    style="float: right;"> <a href="<%= ViewData["backurl"] %>">返回限时折扣活动列表</a>
        </span>
    </div>
    <div class="data">
        <div class="outer">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="DataTableA">
                    ...
                    <tbody class="test">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" value="<%= house.Discount %>" disabled="disabled" style="width: 30px;" />折
                            </td>
                            <td>
                                <%= string.Format("{0:0.00}",(Convert.ToDouble(house.TotalPrice)*1.00*house.Discount/10.00)) %>万元/套
                            </td>
                        </tr>
                        <% } %>
                    </tbody>
