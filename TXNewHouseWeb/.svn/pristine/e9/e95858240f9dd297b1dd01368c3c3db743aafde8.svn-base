    ...
    <div class="content">
        ...
        <div class="mt15 btit clearFix">
            ...
            <div class="font14 fr mr35">
                <a href="<%=TXCommons.GetConfig.BaseUrl%>Activity/TuanGou">创建阶梯团购活动</a>
            </div>
        </div>
        <div class="mt15 clearFix" style="position: relative;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab1">
                ...
                <tr>
                    ...
                    <td>
                        <a target="_blank" href='<%=TXCommons.GetConfig.BaseUrl%>Activity/TuanGouDetail?activityId=<%=Model[i].Id %>'>
                            详情</a> <a target="_blank" href='<%=TXCommons.GetConfig.BaseUrl%>Activity/TuanGouUserList?activityId=<%=Model[i].Id %>'>
                                查看用户报名</a>
                    </td>
                </tr>
                <%}%>
