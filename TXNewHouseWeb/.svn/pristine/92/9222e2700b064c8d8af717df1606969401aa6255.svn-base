<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TXNewHouseManager.Master"
    Inherits="WebRentViewPage<TXModel.AdminPVM.PVE_NH_House>" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="server">
    <%=AdminPageInfo.PageTitle %>-添加房源
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <!--//current-->
    <% using (Html.BeginForm("Add", "NHouse", FormMethod.Post, new {Id = "formadd", Name = "formadd"}))
       { %>
    <div class="data">
            ...
            <div class="tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    <tr>
                        ...
                        <td width="36%">
                            ...
                            <em>
                                <%= Html.DropDownListFor(model => model.BuildingId, Model.Buildings, new {@onblur = "Inspection.BuildingId()"}) %></em>
                        </td>
                        <td width="14%">
                        </td>
                        <td width="36%">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    <tr>
                        ...
                        <td width="86%">
                            <input type="text" value="" id="Name" name="Name" onblur="Inspection.Name()" maxlength="5"><em
                    ...
                    <tr>
                        ...
                        <td>
                            <%= Html.DropDownList("UnitId", Model.Units, new {@onblur = "Inspection.UnitId()"}) %>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <label>
                                <input type="radio" name="loucenType" value="0" class="mr5 ver2" onblur="Inspection.LoucenType()"
                                    checked="checked" />地上楼层</label>
                            <label>
                                <input type="radio" name="loucenType" value="1" class="mr5 ver2" onblur="Inspection.LoucenType()" />地下楼层</label>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <em class="red">*</em> <input type="hidden" value="" id="Floor" name="Floor" />
                            <%= Html.DropDownList("FloorSelect", Model.Floors.Where(it => int.Parse(it.Value) >= 0), new {@id = "dishang", @onblur = "Inspection.Loucen()"}) %>
                            <%= Html.DropDownList("FloorSelect", Model.Floors.Where(it => int.Parse(it.Value) <= 0), new {@id = "dixia", @onblur = "Inspection.Loucen()", @style = "display:none;"}) %>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="Room" id="Room" value="" class="inp mr5 valid" style="width: 30px"
                                   onblur="Inspection.Room()" />
                            室
                            <input type="text" name="Hall" id="Hall" value="" class="inp mr5" style="width: 30px"
                                   onblur="Inspection.Hall()" />
                            厅
                            <input type="text" name="Toilet" id="Toilet" value="" class="inp mr5" style="width: 30px"
                                   onblur="Inspection.Toilet()" />
                            卫
                            <input type="text" name="Kitchen" id="Kitchen" value="" class="inp mr5" style="width: 30px"
                                   onblur="Inspection.Kitchen()" />
                            厨
                            <%-- <input type="text" name="Balcony" id="Balcony" value="" class="inp mr5" style="width: 30px" onblur="Inspection.Balcony()">
                                阳台--%>
                    ...
                    <tr>
                        ...
                        <td>
                            <%= Html.DropDownList("BuildingType", Model.BuildingType, new {@onblur = "Inspection.BuildingType()"}) %>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <%= Html.DropDownList("Orientation", Model.Orientation, new {@onblur = "Inspection.Orientation()"}) %>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <label>
                                <input type="radio" name="PriceType" id="ShiChangPrice" value="0" class="mr5 ver2"
                                    onblur="Inspection.PriceType()" checked="checked" />市场价格</label>
                            <label>
                                <input type="radio" name="PriceType" id="CanKaoPrice" value="1" class="mr5 ver2"
                                    onblur="Inspection.PriceType()" />参考价格</label>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="TotalPrice" id="TotalPrice" value="" class="inp mr5 w100"
                                   onblur="Inspection.TotalPrice()" />万元/套<em class="c-999">&nbsp;&nbsp;&nbsp;&nbsp;请填写数字（例如：15000）</em>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="SinglePrice" id="SinglePrice" value="" class="inp mr5 w100"
                                   onblur="Inspection.SinglePrice()" />元/平方米<em class="c-999">&nbsp;&nbsp;&nbsp;&nbsp;请填写数字（例如：15000）</em>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="DownPayment" id="DownPayment" value="" class="inp mr5 w100"
                                   onblur="Inspection.DownPayment()" />万元<em class="c-999">&nbsp;&nbsp;&nbsp;&nbsp;请填写数字（例如：15000）</em>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <%= Html.DropDownList("SalesStatus", Model.SalesStatuss, new {@onblur = "Inspection.SalesStatus()"}) %>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="BuildingArea" id="BuildingArea" class="inp" onblur="Inspection.BuildingArea()" />平方米
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" name="Area" id="Area" class="inp" onblur="Inspection.BuildingArea()" />平方米
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <span id="rviewNo" style="display: none">加载中...</span><span id="rviewOk"><%= Html.DropDownList("RId", Model.RIds, new {@onblur = "Inspection.RId()"}) %></span>&nbsp;&nbsp;&nbsp;&nbsp;
                            <input type="button" name="UpdateRIds" id="UpdateRIds" value="更新户型图" class="btn4 mr10" />
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="hidden" id="HouseCoordinate" style="width: 500px;" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="btnDiv tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    <tr>
                        ...
                        <td width="86%">
                            <%= Html.Hidden("DeveloperId", Model.DeveloperId) %>
                            ...
                            <input type="button" name="button6" id="button6" value="发布" class="btn3 mr10" />
                        </td>
                    </tr>
                </table>
            </div>
    ...
    $(function() {
        ...
        ManagerBuildPic.Get(selectbuilding.val());
        $(selectbuilding).change(function() {
            ...
            if (this.value != 0) {
                var state = -1;
                $.ajax({
                    url: '<%= Url.SiteUrl().Common("GetBuildingById", "NHouse") %>?id=' + this.value + "&r=" + Math.random(),
                    type: 'POST',
                    aysnc: false,
                    cache: false,
                    done: function(data) {
                ...
                if (state == 4 || state == 5) {
                    alert("该楼栋状态为规划中/建设中，不可发布房源");
                    $(selectbuilding).val(0);
                    return;
                }
...
//                var src = obj.options[index].getAttribute("data");
//                $("#PicSrc").val(src);
        //});
        //ManagerRIds.GetData();//初始化
...
//                }
            ...
            NameRepeat: function () {
                var result= {};
                $.ajax({
                    url: '<%=Auxiliary.Instance.NhManagerUrl %>nhouse/getishousenamerepeat.html',
                    data: { name: $("#Name").val(), buildingid: $("#BuildingId").val(), unitid: $("#UnitId").val(), ram: Math.random },
                    type: 'POST',
                    cache: false,
                    async: false,
                    success: function (msg) {
            ...
            TotalPrice: function () {
                ...
                if (this.IsNullOrEmpty(e))
                    ...
                    if (!reg.test(e.val()))
                        this.SetResult_ToParent(e, false, "请输入正确9位正整数。");
                    else
                        this.SetResult_ToParent(e, true, "");
                }
            },
