...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="current">
        ...
        <span><a href="javascript:void(0);">
            ...
            <i>&gt;</i> <a href="javascript:void(0);">发布楼栋</a></span>
    </div>
    <!--//current-->
    <div class="data">
            ...
            <div class="tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    <tr>
                        ...
                        <td>
                            <%= Html.DropDownListFor(model=>model.PremisesId, Model.Premises) %>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="periods" maxlength="1" />&nbsp;期<span id="err_periods"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" id="unitcount" maxlength="1" /><span id="err_unitcount"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" id="openingtime" /><span id="err_openingtime"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" id="otherstime" /><span id="err_otherstime"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" id="familynum" />&nbsp;&nbsp;户<span id="err_familynum"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" id="thefloor" maxlength="3" />&nbsp;&nbsp;层<span id="err_thefloor"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
                        ...
                        <td>
                            <input type="text" id="underloor" maxlength="3" />&nbsp;&nbsp;层<span id="err_underloor"></span>
                        </td>
                    </tr>
                    <tr>
                        <th>
            ...
            <div class="btnDiv tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    <tr>
                        ...
                        <td width="86%">
                            <input type="button" name="btn_submit" id="btn_submit" value="发布" class="btn1" />
                        </td>
                    </tr>
                </table>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#PremisesId").bind("change", {}, building.changeForPremisesId);
...
//                }
            ...
            addNewPermitPresale: function() {
                ...
                var data = { PremisesId: $("#PremisesId").val(), name: pt };
                $.post(url, data, function(msg) {
                    // 刷新预售许可证列表
                    building.loadPermitPresaleList();
            ...
            // 楼盘变动联动
            changeForPremisesId: function() {
                building.getStateByPremisState();
                building.loadPermitPresaleList();
            },

            // 刷新预售许可证列表
            loadPermitPresaleList: function() {
                clearListItems($("#PresaleId"));
                loadGeographyItems('<%=Url.SiteUrl().GeographyLocation("GetPermitPresalesByPremisesId") %>?id=' + $("#PremisesId").val(), $("#PresaleId"));
            },
            
            // 获取状态列表
            getStateByPremisState: function() {
                clearListItems($("#State"));
                loadGeographyItems('<%= Auxiliary.Instance.NhManagerUrl %>nhbuilding/GetStateByPremisesId.html?premisesId=' + $("#PremisesId").val() + '&ram=' + Math.random(), $("#State"));
            },
            ...
            submit: function() {
                ...
                var url = "<%=Url.SiteUrl().Building_Search("AddNewBuildingDo") %>";
                var data = {
        ...
        var ManagerPlanes = {
            ...
            GetData: function() {
                $.getJSON(this.url, { r: Math.random(), id: this.id }, function(response) {
                    if (response && response.success) {
                        $("#PictureData").html("");
                        $.each(response.items, function() {
                            $("<option value='" + this.ID + "' data='" + this.Path + "' >" + this.Title + "</option>").appendTo($("#PictureData"));
                        });
                ...
                $.getJSON(this.url, { r: Math.random(), id: this.id }, function(response) {
                    if (response && response.success) {
                        ...
                        $.each(response.list, function(i, item) {
                            if (item.IsUsed) {
                                $("<option value=\"" + item.Id + "\" disabled=\"disabled\">" + item.Number + "</option>").appendTo($("#PNum"));
                            } else {
                                $("<option value=\"" + item.Id + "\">" + item.Number + "</option>").appendTo($("#PNum"));
                            }
                        });
                        $("<option value=\"0\" selected=\"selected\">请选择</option>").prependTo($("#PNum"));
                    }
                });
            }
        };
