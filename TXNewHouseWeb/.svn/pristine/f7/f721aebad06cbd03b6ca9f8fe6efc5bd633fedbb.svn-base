      ...
      <div class="clearfix">
        <div class="bgcolor">
            <div class="w1190 line_h50 font14 col666">
                当前位置：<a href="" class="blue">快有家首页</a> > <a href="" class="blue">北京新房</a> > <a href="" class="blue">楼盘主页</a> > 楼盘对比
            </div>
        </div>
        <div class="clearfix loubox brt2">
            <ul>
                ...
                <%string htmlPart = "<li class='h195 pos_rel'><div class='bold'></div><div class='loupho'><img src='' width='170' height='130' alt='' /></div><div class='pos_rel'><input type='button' class='btn_del btn_yhui mr20' value='删除' /><input type='button' class='btn_change btn_yhui' value='换楼盘' /><div class='lppk_yebox' style='display: none;'><div class='close'>&nbsp;</div><input type='text' class='inp_bgre' value='请输入楼盘名称' /><input type='button' class='inp_bgre_btn' style='cursor:pointer' value='' /></div></div></li><li class='nobor_r bkcol_f9f9f9'>&nbsp;</li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='w209 same_li'></li><li class='h44 same_li'></li><li class='same_li'></li><li class='nobor_r bkcol_f9f9f9'>&nbsp;</li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='h44 same_li'></li><li class='nobor_r bkcol_f9f9f9'>&nbsp;</li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='bkcol_f9f9f9'>&nbsp;</li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li></ul></li>";%>
                    ...
                    <ul class="ul_list">
                        <%if (index == 4)
                          ...
                          <li class="bkcol_f9f9f9 cb_same">
                            <input id="btn_cb" type="checkbox" class="btn_checkbox"/><label for="btn_cb">灰色显示相同项目</label></li>
                        <%}
                          else
                          { %>
                        ...
                        <li class="h195 pos_rel">
                            <div class="bold">
                                <%=item.Name %></div>
                            <div class="loupho">
                                <img src="<%=TXCommons.GetConfig.ImgUrl%>images/img_w168_h129.jpg" width="170" height="130" alt="" /></div>
                            <div class="pos_rel">
                                <input type="button" class="btn_del btn_yhui mr20" value="删除" /><input type="button" class="btn_change btn_yhui" value="换楼盘" />
                                <div class="lppk_yebox" style="display: none;">
                                    <div class="close">
                                        &nbsp;</div>
                                    <input type="text" class="inp_bgre" value="请输入楼盘名称" /><input type="button" class="inp_bgre_btn" style="cursor:pointer" value="" />
                                </div>
                            </div>
                        </li>
                        <li class="nobor_r bkcol_f9f9f9">&nbsp;</li>
                        <li class="same_li">均价<%=Convert.ToDouble(item.ReferencePrice)%>元/平方米</li>
                        <li class="same_li"><%=item.DName%></li>
                        <li class="same_li"><%=item.Ring%>环</li>
                        <li class="w209 same_li"><%=item.BName%></li>
                        <li class="h44 same_li"><%=item.PremisesAddress%></li>
                        <li class="same_li"><%=item.Developer%></li>
                        <li class="nobor_r bkcol_f9f9f9">&nbsp;</li>
                        <li class="same_li"><%=item.PropertyRight%>年</li>
                        <li class="same_li"><%=item.BuildingArea%>平方米</li>
                        <li class="same_li"><%=item.Area%>平方米</li>
                        <li class="same_li"><%=item.UserCount%></li>
                        <li class="same_li"><%=TXCommons.NewHouseWeb.HouseType.GetBuildingType(item.BuildingType)%></li>
                        <li class="h44 same_li"><%=item.Characteristic%></li>
                        <li class="nobor_r bkcol_f9f9f9">&nbsp;</li>
                        <li class="same_li"><%=TXCommons.NewHouseWeb.BuildingType.GetPropertyType(item.PropertyType)%></li>
                        <li class="same_li"><%=item.AreaRatio%></li>
                        <li class="same_li"><%=Convert.ToDouble(item.PropertyPrice)%>元/平/月</li>
                        <li class="same_li"><%=item.ParkingLot%></li>
                        <li class="same_li"><%=item.GreeningRate%>%</li>
                        <li class="bkcol_f9f9f9">&nbsp;</li>
                        <li class="h170"><%=item.SupportingIntroduction%></li>
                        <li class="h170"><%=item.School%></li>
                        <li class="h170"><%=item.Shopping%></li>
                        <li class="h170"><%=item.Hospital%></li>
                        <li class="h170"><%=item.Life%></li>
                        <li class="h170"><%=item.Entertainment%></li>
                        <li class="h170"><%=item.Catering%></li>
                        <li class="h170"><%=item.Bus%></li>
                        <li class="h170"><%=item.Subway%></li>
                    </ul>
                </li>
                <%if (index == 4) { break; }}
                    if (index < 4)
                    {
                        ...
                        {
                %>
<li><ul class="ul_list"><%if(i + index + 1 == 4){ %><li class='bkcol_f9f9f9 cb_same'><input type='checkbox' class='btn_checkbox' />灰色显示相同项目</li><%}else{ %><li class="nobor_r bkcol_f9f9f9 nobor_r">&nbsp;</li><%} %><%=htmlPart %>
                <%}}}else{ for (int i = 0; i < 4; i++){%>
                <li><ul class="ul_list"><%if(i == 3){ %><li class='bkcol_f9f9f9 cb_same'><input type='checkbox' class='btn_checkbox' />灰色显示相同项目</li><%}else{ %><li class="nobor_r bkcol_f9f9f9 nobor_r">&nbsp;</li><%} %><%=htmlPart %>
                <%}} %>
            </ul>
            <div class="clear">
            </div>
    ...
    <script type="text/javascript">
        ...
        function DelCompareItem(btn_del) {
            ...
            cb_same.remove();
            $(".loubox").children("ul").append("<li><ul class='ul_list'><li class='bkcol_f9f9f9 cb_same'><input id='btn_cb' type='checkbox' class='btn_checkbox'/><label for='btn_cb'>灰色显示相同项目</label></li><li class='h195 pos_rel'><div class='bold'></div><div class='loupho'><img src='' width='170' height='130' alt='' /></div><div class='pos_rel'><input type='button' class='btn_del btn_yhui mr20' value='删除' /><input type='button' class='btn_change btn_yhui' value='换楼盘' /><div class='lppk_yebox' style='display: none;'><div class='close'>&nbsp;</div><input type='text' class='inp_bgre' value='请输入楼盘名称' /><input type='button' class='inp_bgre_btn' style='cursor:pointer' value='' /></div></div></li><li class='nobor_r bkcol_f9f9f9'>&nbsp;</li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='w209 same_li'></li><li class='h44 same_li'></li><li class='same_li'></li><li class='nobor_r bkcol_f9f9f9'>&nbsp;</li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='h44 same_li'></li><li class='nobor_r bkcol_f9f9f9'>&nbsp;</li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='same_li'></li><li class='bkcol_f9f9f9'>&nbsp;</li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li><li class='h170'></li></ul></li>");
            if (cb_ctl.attr("checked")) {
                $("#btn_cb").trigger("click");
            }
        }

        $(function () {
            //设置相同对比项
            $("#btn_cb").live("click", function () {
            ...
            $(".inp_bgre_btn").live("click", function () {
                ...
                $.ajax({
                    url: "/Premises/GetPremisesByName/",
                    type: "post",
                    dataType: "json",
        ...
        //自动填充
        //$(".inp_bgre").AutoComplete({ dataUrl: "http://search.kuaiyoujia.net/Village/GetVillageIndex.ashx?CityId=253", type: "sq", isAddAtribute: true });
