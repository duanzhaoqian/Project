        ...
        <div class="bgcolor">
            <div class="w1000 line_h50 font14 col666">
                当前位置：<a href="<%=NHWebUrl.KYJIndexUrl() %>" class="blue">快有家首页</a> > <a href="<%=NHWebUrl.NewHouseUrl() %>"
                    class="blue">北京新房</a> > <a href="" class="blue">工具</a> > 购房系统自查系统
            </div>
        </div>
            ...
            <div class="system_box">
                ...
                <div id="table0" class="system_city">
                    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td rowspan="4">
                                <%--<img src="<%=TXCommons.GetConfig.ImgUrl%>images/1306137804050.jpg" width="132" height="253" />--%>
                            </td>
                            <td height="50">
                                <div align="left">
                                    <label onclick="selectdo(1)">
                                        <input type="radio" name="1" class="btn_radio" />三口之家（购房人夫妻双方+未成年子女）</label>
                                    <%--<a href="javascript:selectdo(1);">三口之家（购房人夫妻双方+未成年子女）</a>--%></div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                                <div align="left">
                                <label onclick="selectdo(1)">
                                        <input type="radio" name="1" class="btn_radio" />两口子（购房人夫妻双方）</label>
                                    <%--<a href="javascript:selectdo(1);">两口子（购房人夫妻双方）</a>--%></div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                                <div align="left">
                                <label onclick="selectdo(1)">
                                        <input type="radio" name="1" class="btn_radio" />个人（未婚成年子女）</label>
                                    <%--<a href="javascript:selectdo(1);">个人（未婚成年子女）</a>--%></div>
                            </td>
                        </tr>
                        <tr>
                            <td height="30">
                ...
                <div id="table1" style="display: none;" class="system_city">
                    <table width="500" border="0" align="center" cellpadding="0" cellspacing="0" class="big">
                        ...
                        <tr>
                            ...
                            <td height="50">
                                <div align="left">
                                    <a href="javascript:selectdo(2);">
                                        <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1306137986236.gif" width="16" height="15"
                                            border="0" />
                                        是</a></div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td height="50">
                                <div align="right">
                                    <a href="javascript:selectdo(0);">&lt;&lt;返回上一层</a></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="table2" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        ...
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left">
                                    <span class="STYLE5">您及您的家庭，在北京已经购买了几套住宅？</span><br>
                                    （仅限住宅，商住或商业性质产权物业不纳入）</div>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="4">
                        ...
                        <tr>
                            <td height="50">
                                <div align="right">
                                    <a href="javascript:selectdo(1);">&lt;&lt;返回上一层</a></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="table3" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        ...
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left" class="STYLE5">
                                    您是否持有是否持有在北京连续5年缴纳个人所得税或社会保险缴纳证明？</div>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="3">
                ...
                <div id="table4" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        ...
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left" class="STYLE5">
                                    恭喜您，您是北京户籍且为首次置业，可在京购买住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            <td width="162" rowspan="2">
                            </td>
                            <td width="338" height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">购买首套住房的家庭，贷款首付款比例不得低于30％，贷款利率可享受最低7折优惠（目前北京各大银行实际均执行基准利率）。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">购房所需资料：北京户籍居民及家庭：购房人家庭成员户口簿、结婚证（或单身证明）</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td height="50">
                                <div align="right">
                                    <a href="javascript:selectdo(0);">
                                        <strong>&lt;&lt;重新测试</strong></a></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="table5" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        ...
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left" class="STYLE5">
                                    恭喜您，您是北京户籍且仅有1套住宅，可再购买1套住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            <td width="181" rowspan="2" valign="middle">
                                <%-- --%>
                            </td>
                            <td width="319" height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">对居民家庭向商业银行贷款购买第二套住房的，其首付款比例不得低于60%，贷款利率不得低于基准利率的1.1倍。对为改善居住条件购买第二套住房的，住房公积金个人贷款首付比例不得低于60%，贷款利率不得低于基准利率的1.1倍。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                    ...
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        <tr>
                            <td height="100" colspan="2">
                                <div align="left" class="STYLE5">
                                    很抱歉，您是北京户籍，但已经购置2套或以上住宅，不能在北京再购买住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="456" height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">京十五条明确指出，对已拥有2套及以上住房的本市户籍居民家庭，暂停在本市向其售房。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                ...
                <div id="table7" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        ...
                        <tr>
                            <td height="50">
                                <div align="right">
                                    <a href="javascript:selectdo(3);">&lt;&lt;返回上一层</a></div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                ...
                <div id="table8" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        <tr>
                            ...
                            <td width="454" height="20">
                            </td>
                        </tr>
                        <tr>
                            <td height="120" colspan="2">
                                <div align="left" class="STYLE5">
                                    很抱歉，您是非北京户籍，无法提供本市有效暂住证和连续5年(含)以上在本市缴纳社会保险或个人所得税缴纳证明，不能在北京再购买住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2">
                            ...
                            <td height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">京十五明确指出，无法提供本市有效暂住证和连续5年(含)以上在本市缴纳社会保险或个人所得税缴纳证明的非本市户籍居民家庭，暂停在本市向其售房。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                ...
                <div id="table9" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        ...
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left" class="STYLE5">
                                    恭喜您，您是非北京户籍但并未购置过住宅，可在京购买1套住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="3">
                        ...
                        <tr>
                            <td height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">购房所需资料：非北京户籍居民及家庭：持连续5年(含)以上在本市缴纳社会保险或个人所得税缴纳证明。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                ...
                <div id="table10" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        <tr>
                            ...
                            <td width="441" height="20">
                            </td>
                        </tr>
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left" class="STYLE5">
                                    很抱歉，您是非北京户籍，且已有一套住宅，不能在北京再购买住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2">
                            ...
                            <td height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">京十五条明确指出，拥有1套及以上住房的非本市户籍居民家庭暂停在本市向其售房。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
                ...
                <div id="table11" style="display: none;" class="system_city">
                    <table width="500" border="0" cellspacing="0" cellpadding="0" class="big" align="center">
                        <tr>
                            ...
                            <td width="439" height="20">
                            </td>
                        </tr>
                        <tr>
                            <td height="50" colspan="2">
                                <div align="left" class="STYLE5">
                                    很抱歉，您是非北京户籍，且已有2套及以上住宅，不能在北京再购买住宅！</div>
                            </td>
                        </tr>
                        <tr>
                            <td rowspan="2">
                            ...
                            <td height="50">
                                <div align="left">
                                    <img src="<%=TXCommons.GetConfig.ImgUrl%>images/1305791108722.gif" width="16" height="15"
                                        border="0">沪九条明确指出，对于拥有1套及以上住房的非本市户籍居民家庭暂停在本市向其售房。违反规定购房的，不予办理房地产登记。</div>
                            </td>
                        </tr>
                        <tr>
                            <td height="50">
