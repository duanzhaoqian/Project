...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content">
        <h4 class="title_h4 mb10">
            <span>创建砍价</span><em class="ts_right"><a href="<%=TXCommons.GetConfig.BaseUrl%>Activity/BargainList">返回砍价房源列表
            </a></em>
        </h4>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_box1"
            ...
            <tr>
                ...
                <td id="td_maxmargin01">
                    单次减价不高于<input type="text" class="input_wauto w180 mr10" id="txtMaxPrice" /><span>万元</span>
                </td>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#btn_sure02").click(function () {
                ...
                if (Verify.IsEmpty(bidPrice.val())) return Verify.Error("保底价格不能为空", bidPrice.next());
            ...
            jQuery.ajax({ type: "post", async: false, url: mainUrl + "/Activity/GetFloor", data: { PremisesId: PremisesId, BuildingId: BuildingId, UnitId: UnitId, m: Math.random() }, dataType: "json", cache: false,
                success: function (data) {
                    ...
                    $.each(data, function (index, Floor) {
                        var otherlink = "<a data-floorid='" + Floor + "' onclick='SelectOption(this,2);SelectOption(this,2)'>" + Floor + "层</a>";
        ...
        function Complete() {
            ...
            $.ajax({
                url: "/Activity/CreateBargain",
                type: 'post',
                cache: false,
                dataType: "json",
                async: false,
                data: { cityId: cityId, premisesId: premisesId, bidPrice: bidPrice.val(), addPrice: addPrice.val(), maxPrice: maxPrice.val(), bond: bond.val(), start: start.val(), end: end.val(), Ids: house, activState: activState, m: Math.random() },
                success: function (data) {
                    if (data.sucess != "0") {
                        window.location = "<%=TXCommons.GetConfig.BaseUrl%>" + "Activity/BargainList";
                        //                        ShowCondition();
                        //                        QueryHouse();
