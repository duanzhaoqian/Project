    ...
    <div class="content">
        <div class="mt15 btit clearFix">
            ...
            <div class="font14 fr mr35">
                <a href="<%=TXCommons.GetConfig.BaseUrl%>Activity/Bargain">创建砍价</a></div>
        </div>
  ...
  <div class="fen">
    ...
    <script type="text/javascript">
        ...
        function QueryHouse() {
            ...
            jQuery.ajax({ type: "get", async: false, url: mainUrl + "/Activity/BargainList", data: { premisesId: premisesId, buildId: buildId, unitId: unitId, floorId: floorId, activState: activState, m: Math.random() }, cache: false,
                success: function (data) {
