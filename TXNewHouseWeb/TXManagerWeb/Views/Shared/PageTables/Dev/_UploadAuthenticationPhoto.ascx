...
%>
<link href="<%= Auxiliary.Instance.NhManagerUrl + "js/uploadify/uploadify.css" %>" rel="stylesheet" type="text/css" />

<div id="divUpload">
    <span class="ps_r"><input id="fileUpload" type="file" value="上传图片" class="bnt_w123" /></span>
    <%--显示图片错误信息，用于身份认证页验证--%>
    <span id="errImg" style="display:none;" class="lose">请选择文件。</span>
...
<script src="<%= Auxiliary.Instance.NhManagerUrl + "js/uploadify/jquery.uploadify.js" %>" type="text/javascript"></script>
