<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/TXNewHouseManager.Master"
    Inherits="WebRentViewPage<TXModel.AdminPVM.PVE_NH_Biding>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <span><a href="javascript:void(0);">
            ...
            <i>&gt;</i> <a href="javascript:void(0);">
                <%=AdminPageInfo.ItemName %></a><i>&gt;</i> <a href="javascript:void(0);">修改
                    <%=Model.PremisesName +" "+ Model.BuildingName+Model.BuildingType+" "+Model.UnitName+" "+Model.Floor+"层 "+Model.HouseName%>
                    竞价活动</a></span>
    </div>
    <!--//current-->
    <div class="data">
        ...
        <div class="outer">
            ...
            <div class="filterBar" style="background-color: White; border-bottom: 1px solid #999999;">
                ...
                <%=Html.DropDownListFor(it =>it.SalesStatus , Model.SalesStatuss,new{ style="display:none;"})%>
            ...
            <div class="tab1">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb1">
                    ...
                    <tr>
                        ...
                        <td width="92%">
                            单次加价不高于<%=Html.TextBox("MaxPrice", string.Format("{0:F0}", Model.MaxPrice))%>万元
                        </td>
                    </tr>
                    <tr>
                        <th width="8%">
    ...
    var BidingModify = {
        ...
        LoadData: function (pageindex) {
            ...
            $("#ListResult").load('<%=Url.SiteUrl().NhBidingUser_Search("housesearchresult")%>?&pageindex=' + pageindex + BidingModify.Url(), function () {
        ...
        PostCount: function () {
            ...
            //请求数据 并生产分页链接
            $.post(
                '<%=Url.SiteUrl().NhBidingUser_Search("housesearchcount")%>',
                BidingModify.Data(),
                function (data) {
        ...
        Modify: function () {
            $.post("<%=Url.SiteUrl().NhBidingUser_Search("Modify")%>", BidingModify.ModifyDate(), function (result) {
                if (result.result) {
                    alert("修改成功");
