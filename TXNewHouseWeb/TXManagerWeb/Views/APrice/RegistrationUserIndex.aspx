...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="current">
        ...
        <span><a href="javascript:void(0);">
            ...
            <i>&gt;</i> <a href="javascript:void(0);">
                <%=AdminPageInfo.ItemName %></a>-一口价报名用户列表</span>
    </div>
    <!--//current-->
    <div class="data">
        <!-- InstanceBeginEditable name="EditRegion3" -->
        <% using (Html.BeginForm("RegistrationUserSearch", "APrice", FormMethod.Post, new { Id = "searchForm", Name = "searchForm" }))
           { %>
        <div class="filterBar" style="display: block;">
            ...
            <div class="icon_buttonA dingwei2">
                <span style=" float:left; padding-right:500px"><%=ViewData["GetHouseInfos"]%></span>
                <div class="L">
                </div>
                <div class="C">
                    <a href="<%=Url.SiteUrl().ActionUrl("ExportExcel","APrice") %>?Id=<%=Model.Id %>&Type=<%=Model.Type %>"
    ...
    <script type="text/javascript">
        ...
        function pageselectCallback(page_index, jq) {
            ...
            $("#ListResult").load("<%=Url.SiteUrl().APriceUser_Search("RegistrationUserSearchResult")%>?Id=<%=Model.Id %>&pageindex=" + page_index + "&pagesize=" + opts.items_per_page);
        }
        //初始化分页参数
        ...
        $(document).ready(function () {
            $.post("<%=Url.SiteUrl().APriceUser_Search("RegistrationUserSearchCount")%>?Id=<%=Model.Id %>", function (data, textStatus) {
