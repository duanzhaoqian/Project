...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="data">
        ...
        <% using (Html.BeginForm("search", "APrice", FormMethod.Post, new { Id = "searchForm", Name = "searchForm" }))
           {%>
        <div class="filterBar">
    ...
    <script type="text/javascript">
        ...
        function pageselectCallback(page_index, jq) {
            ...
            $("#ListResult").load("<%=Url.SiteUrl().APrice_SearchResult("searchresult",Model)%>?DeveloperName=<%=Model.DeveloperName %>&pageindex=" + page_index + "&pagesize=" + opts.items_per_page);
        }
        //初始化分页参数
        ...
        $(document).ready(function () {
            $.post("<%=Url.SiteUrl().APrice_SearchResult("searchcount",Model)%>?DeveloperName=<%=Model.DeveloperName %>", function (data, textStatus) {
