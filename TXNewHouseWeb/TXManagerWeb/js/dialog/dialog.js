...
function Dialog(content, options) {
    ...
    var isIe = $.support.boxModel;
    //var isIe6 = $.browser.msie && ('6.0' == $.browser.version);
    var isIe6 = $.support.boxModel && $.support.leadingWhitespace;
    /* 对话框的布局及标题内容。*/
    var barHtml = !options.showTitle ? '' :
	 '<div class="hd"><b class="' + options.titleClass + '">' + options.title + '</b> <a href="' + options.closeUrl + '" class="close">' + options.closeText + '</a></div>'
