/**
* jQuery freeResizable UI 1.1.1 [调整窗体大小]
...
(function ($)
{
    $.fn.freeResizable = function (options)
    {
        return $.freeui.run.call(this, "freeResizable", arguments,
        {
            idAttrName: 'freeuiresizableid', hasElement: false, propertyToElemnt: 'target'
        });
    };

    $.fn.freeGetResizableManager = function ()
    {
        return $.freeui.run.call(this, "freeGetResizableManager", arguments,
        {
            idAttrName: 'freeuiresizableid', hasElement: false, propertyToElemnt: 'target'
        });
    };
    ...
    $.freeui.controls.Resizable = function (options)
    {
        $.freeui.controls.Resizable.base.constructor.call(this, null, options);
    };

    $.freeui.controls.Resizable.freeExtend($.freeui.core.UIComponent, {
        __getType: function ()
        {
            return 'Resizable';
        },
        ...
        _render: function ()
        {
            ...
            g.target.mousemove(function (e)
            {
                ...
                if (p.target.freeuidragid)
                {
                    var drag = $.freeui.get(p.target.freeuidragid);
                    if (drag && g.dir)
                    {
        ...
        _rendered: function ()
        {
            this.options.target.freeuiresizableid = this.id;
        },
        _getDir: function (e)
        {
            var g = this, p = this.options;
