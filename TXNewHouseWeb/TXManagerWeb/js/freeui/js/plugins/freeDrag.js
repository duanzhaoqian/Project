/**
* jQuery freeDrag UI 1.1.1 [窗体拖动插件]
...
(function ($)
{
    ...
    $.fn.freeDrag = function (options)
    {
        return l.run.call(this, "freeDrag", arguments,
        {
            idAttrName: 'freeuidragid', hasElement: false, propertyToElemnt: 'target'
        }
        );
    };

    $.fn.freeGetDragManager = function ()
    {
        return l.run.call(this, "freeGetDragManager", arguments,
        {
            idAttrName: 'freeuidragid', hasElement: false, propertyToElemnt: 'target'
        });
    };
    ...
    l.controls.Drag.freeExtend(l.core.UIComponent, {
        __getType: function ()
        {
            return 'Drag';
        },
        ...
        _rendered: function ()
        {
            this.options.target.freeuidragid = this.id;
        },
        _start: function (e)
        {
            var g = this, p = this.options;
