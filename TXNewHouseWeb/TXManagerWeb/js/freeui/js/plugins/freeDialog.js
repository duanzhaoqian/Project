...
(function ($)
{
    ...
    //全局事件
    $(".l-dialog-btn").bind('mouseover', function ()
    {
    ...
    $(".l-dialog-tc .l-dialog-close").bind('mouseover', function ()
    {
    ...
    //dialog 图片文件夹的路径 预加载
    $.freeui.DialogImagePath = "../../freeUI/skins/deepblue/images/dialog/";
    ...
    $.freeDefaults.Dialog = {
        ...
        slide: $.support.msie ? false : true,        //是否以动画的形式显示 
