...
namespace Kernel
{
    ...
    public class StateObject:IDisposable
    {
        ...
        private byte[] _TempReceiveBuffer = null;
        ...
        private bool _IsAVStream = false;//是否传输音视频流
        private byte[] _AVStream = null;
        //private byte[] _HeadReceiveBuffer = null;
        ...
        /// <summary>
        ///是否传输音视频流，{false:否；true:是}
        ///传输音视频流则以裸流发送
        /// </summary>
        //public bool IsAVStream
        //{
        //    get
        //    {
        //        return this._IsAVStream;
        //    }
        //    set
        //    {
        //        this._IsAVStream = value;
        //    }
        //}
        ...
        public byte[] AVStream
        {
            get
            {
                return this._AVStream;
            }
            set
            {
                this._AVStream = value;
            }
        }
        ...
        public List<byte> ListReceiveBuffer = new List<byte>();
        public List<byte> ListHeadBuffer = new List<byte>();


        public byte[] TempReceiveBuffer
        {
            get
            {
                return this._TempReceiveBuffer;
            }
            set
            {
                this._TempReceiveBuffer = value;
            }
        }
