...
namespace KYJ.ZS.Web.Controllers.ActionFilters
{
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (invalidRequestUrl)
            {
                filterContext.Result = new RedirectResult(
                    KYJ.ZS.Commons.PubConstant.UserBaseUrl + new UrlHelper(filterContext.RequestContext).RouteUrl("Default", new { action = "login", controller = "common", returnUrl = KYJ.ZS.Commons.PubConstant.WebBaseUrl + returnUrl }));
            }
        }
    }
}
