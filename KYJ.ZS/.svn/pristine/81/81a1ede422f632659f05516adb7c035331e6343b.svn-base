...
namespace KYJ.ZS.Special.Controllers.ActionFilters
{
        ...
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (invalidRequestUrl)
            {
                filterContext.Result = new RedirectResult(
                    new UrlHelper(filterContext.RequestContext).RouteUrl("Default", new { action = "login", controller = "common", returnUrl = KYJ.ZS.Commons.PubConstant.UserBaseUrl + returnUrl }));
            }
        }
    }
}
