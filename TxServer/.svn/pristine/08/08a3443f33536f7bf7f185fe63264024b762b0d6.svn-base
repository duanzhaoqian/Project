...
namespace TXSearch.Company
{
    /// <summary>
    /// Handler1 的摘要说明
    /// </summary>
    public class GetCompanyIndex : IHttpHandler
    {
        public static log4net.ILog logger = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        public static string BasePath = AppDomain.CurrentDomain.BaseDirectory;
        public static string IndexPath = BasePath + "CompanyIndex/";
       ...
       //public static IndexSearcher indexSearcher =new IndexSearcher(directory, true);
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            string size = string.IsNullOrEmpty(context.Request.Params["size"]) ? "10" : context.Request.Params["size"];
                ...
                try
                {
                    System.Data.DataSet ds = (System.Data.DataSet)Search( q,size);
                    if (type == "xml")
                    {
                    ...
                    else if (type == "array")
                    {
                        ...
                        if (ds != null && ds.Tables.Count > 0 && ds.Tables[1].Rows.Count > 0)
                        {
                            ...
                            foreach (DataRow row in ds.Tables[1].Rows)
                            {
                                ...
                                str.Append("VID:'" + row["VID"].ToString() + "',");
        ...
        public object Search(string q,string size)
        {
