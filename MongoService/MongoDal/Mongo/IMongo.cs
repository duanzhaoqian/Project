...
namespace Mongo
{
    public interface IMongo
    {
        ...
        WriteConcernResult Delete(string collectionName, string _id);
        WriteConcernResult DeleteAll(string collectionName);
        WriteConcernResult DeleteAll(string collectionName, IMongoQuery query);
        ...
        IEnumerable<WriteConcernResult> InsertAll<T>(string collectionName, IEnumerable<T> entitys);
        void InsertOne<T>(string collectionName, T entity);
        bool InsertOneSafe<T>(string collectionName, T entity);
        WriteConcernResult UpdateAll<T>(string collectionName, IMongoQuery query, IMongoUpdate update);
        WriteConcernResult UpdateOne<T>(string collectionName, T entity);
